...
const _tree = {
  ...
  "root": true,
  "ownMeta": {},
  "absolutePath": "D:/project/nodejs/movie-database/src/pages/_layout.svelte",
  "children": [
    {
      "isFile": true,
      "isDir": false,
      ...
      "ext": "svelte",
      "badExt": false,
      "absolutePath": "D:/project/nodejs/movie-database/src/pages/index.svelte",
      ...
      "path": "/index",
      "id": "_index",
      "component": () => import('./index-5f24785d.js').then(m => m.default)
    },
    {
      "isFile": false,
      "isDir": true,
      ...
      "ext": "",
      "badExt": false,
      "absolutePath": "D:/project/nodejs/movie-database/src/pages/movie",
      "children": [
        {
          "isFile": true,
          "isDir": false,
          ...
          "ext": "svelte",
          "badExt": false,
          "absolutePath": "D:/project/nodejs/movie-database/src/pages/movie/[id].svelte",
          ...
          "path": "/movie/:id",
          "id": "_movie__id",
          "component": () => import('./_id_-a69c69a0.js').then(m => m.default)
        }
      ],
      "isLayout": false,
      "isReset": false,
    ...
    },
    {
      ...
      "ext": "",
      "badExt": false,
      "absolutePath": "D:/project/nodejs/movie-database/src/pages/search",
      "children": [
        {
          "isFile": true,
          "isDir": false,
          "file": "[keyword].svelte",
          "filepath": "/search/[keyword].svelte",
          "name": "[keyword]",
          "ext": "svelte",
          "badExt": false,
          "absolutePath": "D:/project/nodejs/movie-database/src/pages/search/[keyword].svelte",
          "importPath": "../src/pages/search/[keyword].svelte",
          "isLayout": false,
          "isReset": false,
          "isIndex": false,
          "isFallback": false,
          ...
          "path": "/search/:keyword",
          "id": "_search__keyword",
          "component": () => import('./_keyword_-29e424b9.js').then(m => m.default)
        }
      ],
      "isLayout": false,
      "isReset": false,
  ...
  "path": "/",
  "id": "__layout",
  "component": () => import('./_layout-edd61d79.js').then(m => m.default)
};
...
export { destroy_component as A, group_outros as B, add_render_callback as C, create_in_transition as D, create_out_transition as E, svg_element as F, text as G, src_url_equal as H, set_data_dev as I, validate_each_argument as J, destroy_each as K, params as L, empty as M, create_slot as N, update_slot_base as O, get_all_dirty_from_scope as P, get_slot_changes as Q, app as R, SvelteComponentDev as S, validate_slots as a, space as b, component_subscribe as c, dispatch_dev as d, element as e, attr_dev as f, goto as g, add_location as h, init$1 as i, insert_dev as j, append_dev as k, set_input_value as l, listen_dev as m, noop as n, detach_dev as o, prevent_default as p, onMount as q, run_all as r, safe_not_equal as s, globals as t, create_component as u, validate_store as v, mount_component as w, transition_out as x, check_outros as y, transition_in as z };
//# sourceMappingURL=main-ff8789af.js.map
